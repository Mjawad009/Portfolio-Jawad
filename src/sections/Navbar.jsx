...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <div
        className="fixed z-50 flex flex-col items-center justify-center gap-1 transition-all duration-300 bg-black rounded-full cursor-pointer w-14 h-14 md:w-20 md:h-20 top-4 right-6 sm:right-10"
        onClick={toggleMenu}
        style={
          showBurger
